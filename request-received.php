...
<head>
	<title>Elderly Chronic Disease Information System !! Request Received</title>
	...
	<div class="breadcrumb-agile">
		<div aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">Disease outbreaks</li>
			</ol>
		</div>
	</div>
	<!-- //page details -->
	...
	<div class="appointment py-5">
		<div class="py-xl-5 py-lg-3">
			<div class="w3ls-titles text-center mb-5">
				<h3 class="title">Disease outbreaks</h3>
				<span>
			...
			<div class="d-flex">
				...
				<div class="contact-right-w3l appoint-form" style="width:100% !important;">
					<h5 class="title-w3 text-center mb-5">Below is the detail of disease outbreaks.</h5>
