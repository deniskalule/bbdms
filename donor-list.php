...
<head>
	<title>Elderly&Chronic Disease Information System | Volunteer List </title>
	<!-- Meta tag Keywords -->
	...
	<div class="agileits-contact py-5">
		<div class="py-xl-5 py-lg-3">
			...
			<div class="w3ls-titles text-center mb-5">
				<h3 class="title">Volunteer List</h3>
				<span>
					<i class="fas fa-user-md"></i>
				</span>
				<p class="mt-2">These are some of the volunteers. You too can become a volunteer.</p>
			</div>
			<div class="d-flex">
