...
(1, 'Admin', 'admin', 776481096, 'admin@gmail.com', '202cb962ac59075b964b07152d234b70', '2022-07-28 04:36:52');
...
(8, 'Diabetes', '2023-08-27 19:37:03'),
(9, 'Blood Pressure', '2023-08-27 19:37:23'),
(10, 'Cancer', '2023-08-29 13:35:35'),
(12, 'Asthma', '2023-08-31 11:15:42');
...
(1, 'Kyambogo Uganda																							', 'info@ecdis.com', '0776481096');
...
(8, 'Denis Jotham Kalule', 'denisjothamzkalule@gmail.com', '0776481096', 'hello', '2023-08-15 09:54:20', 1);
...
--
-- Error reading structure for table bbdms.tblpatients: #1030 - Got error 194 &quot;Tablespace is missing for a table&quot; from storage engine InnoDB
-- Error reading data for table bbdms.tblpatients: #1064 - You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'FROM `bbdms`.`tblpatients`' at line 1
