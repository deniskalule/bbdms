...
<head>
	...
	<title>Elderly & Chronic Disease Information System | Admin Login</title>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<h1 class="text-center text-bold text-light mt-4x">Elderly & Chronic Disease information System Sign in</h1>
