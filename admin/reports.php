            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <!-- Add the date input fields to the HTML form -->
                        <div class="search-section ">
                            <h4><b><u>Filter by Date Range</u></b></h4>
                            <form action="" class="form d-flex">
                                ...
                                <div class="form-group ml-4">
                                    <label>To: </label>
                                    <input type="date" name="to_date" required style="width: 300px; border: 1px solid #2222220;">
                                </div>
                                <button type="submit" name="search" class="search btn btn-sm btn-primary ml-4" style="height: 30px;">Search</button>
                            </form>
                        </div>
                        ...
                        <div class="panel panel-default mb-2">
                            ...
                            <div class="panel-body">
                                <?php if ($error) { ?><div class="alert alert-danger errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } else if ($msg) { ?><div class="alert alert-success succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php } ?>
								<!-- Add the "Print Report" button -->
								<a href="javascript:void(0);" onclick="printReport();" class="btn btn-sm btn-success mb-2"><i class="fa fa-print" aria-hidden="true"></i> Print Report </a>
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_GET['search'])) {
                                            ...
                                            $sql = "SELECT * FROM patients WHERE DATE(addition_date) BETWEEN :from_date AND :to_date";
                                            $query = $dbh->prepare($sql);
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo htmlentities($result->addition_date); ?></td>
                                                </tr>
                                        <?php
                                                $cnt = $cnt + 1;
                                            }
