...
<head>
	...
	<title>Elderly chronic Disease Information System | Forgot Password</title>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<h1 class="text-center text-bold text-light mt-4x">Elderly chronic Disease Information System Forgot Password</h1>
